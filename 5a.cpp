...
advent_t advent( std::vector< std::string > const& input )
{
    ...
    {
        std::cerr << X(humidity_to_location,X(temperature_to_humidity,X(light_to_temperature,X(water_to_light,X(fertilizer_to_water,X(soil_to_fertilizer,X(seed_to_soil,seed)))))))<<'\n';
    }
